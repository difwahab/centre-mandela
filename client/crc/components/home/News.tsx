      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {newsLoading ? (
            ...
            // Render actual news
            newsData.slice(0, 3).map((post: NewsPost) => (
              <div key={post.id} className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="h-48 overflow-hidden">
                  <img 
                    src={post.imageUrl || "https://images.unsplash.com/photo-1530497610245-94d3c16cda28?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=450"} 
                    alt={post.title}
                ...
                <div className="p-6">
                  <div className="flex items-center text-text-medium text-sm mb-2">
                    ...
                    <span>{formatDate(post.publishDate.toString())}</span>
                  </div>
                  ...
                  <a href="#" className="text-primary font-medium hover:underline group">
                    {t('news.readMore')} <ChevronRight className="inline-block h-4 w-4 transition-transform group-hover:translate-x-1" />
                  </a>
                </div>
              </div>
            ))
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {tipsLoading ? (
              // Loading skeleton for health tips
              ...
              // Render actual health tips
              tipsData.slice(0, 2).map((tip: NewsPost, index: number) => (
