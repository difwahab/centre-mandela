          ...
          <div className="order-2 md:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#rendez-vous">
                <Button
                  size="lg"
                  className="bg-primary text-white hover:bg-primary/90 transition-all hover:-translate-y-0.5 hover:shadow-md"
                >
              ...
              <a href="#services">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-primary text-primary hover:bg-primary/5 transition-all hover:-translate-y-0.5 hover:shadow-md"
                >
